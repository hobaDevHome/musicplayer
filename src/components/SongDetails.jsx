...
const SongDetails = ({ songs, changesong }) => {
    ...
    >
      <div className="flex max-sm:flex-col md:flex-row w-full ">
          ...
          <div className="flex max-sm:flex-col md:flex-row itemx-center p-4 ">
            ...
            <div className="flex flex-col pl-3 mt-2">
              <div className="text-lg text-gray-700 pb-3 sm:self-center md:self-start">
                <span className="font-bold">Track</span> : {currentSong.name}
              </div>
              <div className="text-lg text-gray-700 pb-3 sm:self-center md:self-start">
              ...
              <div className="text-lg text-gray-700 pb-3 sm:self-center md:self-start">
                <PlayCircleIcon
                  className="h-14 w-14 text-orange-700 cursor-pointer hover:scale-125 transition-all duration-300"
        ...
        <div className="bg-white  max-sm:w-11/12 md:w-1/3 m-4 flex flex-col h-fit">
          <div className="flex items-center pl-3 h-10 border-1 bg-gray-200 text-sm">
            Suggestions
          </div>
          {suggs.length > 0 && (
            <>
